...
**Skills**は、AI エージェントに新しい機能やドメイン知識を追加するための仕組みです。2026 年現在、主に 2 つのアプローチが存在します：

1. **静的コンテキストベースの Skills** - マークダウンファイル（SKILL.md）で知識を埋め込む
2. **動的ツールベースの MCP** - Model Context Protocol でリアルタイムのツール接続
